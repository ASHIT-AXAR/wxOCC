...
BEGIN_EVENT_TABLE(wxOCEWindow, wxScrolledWindow)
EVT_SIZE(wxOCEWindow::OnSize)
EVT_IDLE(wxOCEWindow::OnIdle)
EVT_LEFT_DOWN(wxOCEWindow::OnLeftDown)
EVT_LEFT_UP(wxOCEWindow::OnLeftUp)
EVT_MOTION(wxOCEWindow::OnMotion)
EVT_RIGHT_DOWN(wxOCEWindow::OnRightDown)
EVT_RIGHT_UP(wxOCEWindow::OnRightUp)
END_EVENT_TABLE()


wxOCEWindow::wxOCEWindow(
wxWindow *parent,
const wxPoint& pos,
const wxSize& size,
long style)
...
//    Reader.ReadFile("/home/dax/Downloads/High Torque  U-Joint.STEP");
...
TopoDS_Shape wxOCEWindow::MakeBottle(const Standard_Real myWidth, const Standard_Real myHeight, const Standard_Real myThickness)
{
...
void wxOCEWindow::OnDraw(wxDC& dc)
{
...
void wxOCEWindow::DoSetToShaded()
{
    int width, height;
...
void wxOCEWindow::DoSetToWireframe()
{
    int width, height;
...
void wxOCEWindow::DoZoomSelection()
{
...
void wxOCEWindow::OnLeftDown(wxMouseEvent& event)
{
...
void wxOCEWindow::OnLeftUp(wxMouseEvent& event)
{
event.GetPosition(&xMouse,&yMouse);
...
void wxOCEWindow::OnRightDown(wxMouseEvent& event)
{
event.GetPosition(&xMouse,&yMouse);
...
void wxOCEWindow::OnRightUp(wxMouseEvent& WXUNUSED(event))
{
wxWindow::SetCursor(wxCursor(wxCURSOR_ARROW));
}

void wxOCEWindow::OnMotion(wxMouseEvent& event)
{
...
void wxOCEWindow::CurMove(long& xcoord, long& ycoord)
{
...
void wxOCEWindow::CtrlZoom(long x1, long y1, long x2, long y2)
{
wxWindow::SetCursor(wxCursor(wxCURSOR_MAGNIFIER));
...
void wxOCEWindow::CtrlRotate(long& xcoord, long& ycoord)
{
...
void wxOCEWindow::ShiftSelectObject ( const Standard_Integer flag)
{
...
void wxOCEWindow::SelectObject(const Standard_Integer flag)
{
...
void wxOCEWindow::DrawRectangle(long initX, long initY, long finalX, long finalY, bool Draw)
{
