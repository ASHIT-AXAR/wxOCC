    ...
    : wxFrame(parent, id, title, pos, size, style)
{
    ...
    m_menuItem7 = new wxMenuItem(m_name6, wxID_REFRESH, _("Refresh View"), _("Refresh"), wxITEM_NORMAL);
    m_name6->Append(m_menuItem7);
    
    m_name8 = new wxMenu();
    m_menuBar->Append(m_name8, _("Modify"));
    
    m_menuItem9 = new wxMenuItem(m_name8, wxID_RESET, _("Change Size..."), wxT(""), wxITEM_NORMAL);
    ...
    this->Connect(wxID_ANY, wxEVT_SHOW, wxShowEventHandler(MainFrameBaseClass::OnShow),NULL, this);
