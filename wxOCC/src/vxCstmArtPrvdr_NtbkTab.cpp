...
// -- DefaultTabArt class implementation --

DefaultTabArt::DefaultTabArt()
{
    m_normalFont = *wxNORMAL_FONT;
    m_selectedFont = *wxNORMAL_FONT;
    m_selectedFont.SetWeight(wxFONTWEIGHT_BOLD);
...
wxAuiTabArt* DefaultTabArt::Clone()
{
    return new DefaultTabArt(*this);
}

void DefaultTabArt::SetFlags(unsigned int flags)
{
    m_flags = flags;
}

void DefaultTabArt::SetSizingInfo(const wxSize& tab_ctrl_size,
                                       size_t tab_count)
{
    m_fixedTabWidth = 100;
...
void DefaultTabArt::DrawBorder(wxDC& dc, wxWindow* wnd, const wxRect& rect)
{
    int i, border_width = GetBorderWidth(wnd);
...
void DefaultTabArt::DrawTab(wxDC& dc,
                                 wxWindow* wnd,
                                 const wxAuiNotebookPage& page,
                                 const wxRect& in_rect,
                                 int close_button_state,
...
int DefaultTabArt::GetIndentSize()
{
    return 5;
}

int DefaultTabArt::GetBorderWidth(wxWindow* wnd)
{
    wxAuiManager* mgr = wxAuiManager::GetManager(wnd);
    if (mgr)
    {
...
int DefaultTabArt::GetAdditionalBorderSpace(wxWindow* WXUNUSED(wnd))
{
    return 0;
}

wxSize DefaultTabArt::GetTabSize(wxDC& dc,
                                      wxWindow* WXUNUSED(wnd),
                                      const wxString& caption,
...
void DefaultTabArt::DrawButton(wxDC& dc,
                                    wxWindow* WXUNUSED(wnd),
                                    const wxRect& in_rect,
                                    int bitmap_id,
                                    int button_state,
...
int DefaultTabArt::ShowDropDown(wxWindow* wnd,
                                     const wxAuiNotebookPageArray& pages,
                                     int /*active_idx*/)
{
    wxMenu menuPopup;
...
int DefaultTabArt::GetBestTabCtrlSize(wxWindow* wnd,
                                           const wxAuiNotebookPageArray& pages,
...
void DefaultTabArt::SetNormalFont(const wxFont& font)
{
    m_normalFont = font;
}

void DefaultTabArt::SetSelectedFont(const wxFont& font)
{
    m_selectedFont = font;
}

void DefaultTabArt::SetMeasuringFont(const wxFont& font)
{
    m_measuringFont = font;
}

void DefaultTabArt::SetColour(const wxColour& colour)
{
    m_baseColour = colour;
...
void DefaultTabArt::SetActiveColour(const wxColour& colour)
{
