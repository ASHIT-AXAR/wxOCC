...
vxCstmArtPrvdr_AUIToolbar::vxCstmArtPrvdr_AUIToolbar()
{
    ...
    m_gripperPen1 = wxPen( *wxBLACK);
    m_gripperPen2 = wxPen( *wxBLACK);
    m_gripperPen3 = *wxGREY_PEN;
...
void vxCstmArtPrvdr_AUIToolbar::ResetToDefault()
{
    m_baseColour = GetBaseColor();
...
void vxCstmArtPrvdr_AUIToolbar::SetToolBarBaseColour(wxColour baseColour)
{
...
void vxCstmArtPrvdr_AUIToolbar::SetButtonHighliteColour(wxColour buttonHighliteColour)
{
...
wxAuiToolBarArt* vxCstmArtPrvdr_AUIToolbar::Clone()
{
    return static_cast<wxAuiToolBarArt*>(new wxAuiDefaultToolBarArt);
}

void vxCstmArtPrvdr_AUIToolbar::SetFlags(unsigned int flags)
{
    m_flags = flags;
}

void vxCstmArtPrvdr_AUIToolbar::SetFont(const wxFont& font)
{
    m_font = font;
}

void vxCstmArtPrvdr_AUIToolbar::SetTextOrientation(int orientation)
{
    m_textOrientation = orientation;
}

unsigned int vxCstmArtPrvdr_AUIToolbar::GetFlags()
{
    return m_flags;
}

wxFont vxCstmArtPrvdr_AUIToolbar::GetFont()
{
    return m_font;
}

int vxCstmArtPrvdr_AUIToolbar::GetTextOrientation()
{
    return m_textOrientation;
}

void vxCstmArtPrvdr_AUIToolbar::DrawBackground(
    wxDC& dc,
    ...
    const wxRect& _rect)
{
    ...
    wxColour startColour = m_baseColour.ChangeLightness(120);
    wxColour endColour = m_baseColour.ChangeLightness(90);
    dc.GradientFillLinear(rect, startColour, endColour, wxSOUTH);
}

void vxCstmArtPrvdr_AUIToolbar::DrawPlainBackground(wxDC& dc,
        wxWindow* WXUNUSED(wnd),
        const wxRect& _rect)
{
    wxRect rect = _rect;
...
void vxCstmArtPrvdr_AUIToolbar::DrawLabel(
    wxDC& dc,
    wxWindow* WXUNUSED(wnd),
...
void vxCstmArtPrvdr_AUIToolbar::DrawButton(
    wxDC& dc,
    wxWindow* WXUNUSED(wnd),
    const wxAuiToolBarItem& item,
    const wxRect& rect)
...
void vxCstmArtPrvdr_AUIToolbar::DrawDropDownButton(
    wxDC& dc,
    wxWindow* WXUNUSED(wnd),
    const wxAuiToolBarItem& item,
    const wxRect& rect)
...
void vxCstmArtPrvdr_AUIToolbar::DrawControlLabel(
    wxDC& dc,
    wxWindow* WXUNUSED(wnd),
    const wxAuiToolBarItem& item,
    const wxRect& rect)
...
wxSize vxCstmArtPrvdr_AUIToolbar::GetLabelSize(
    wxDC& dc,
    wxWindow* WXUNUSED(wnd),
    const wxAuiToolBarItem& item)
{
...
wxSize vxCstmArtPrvdr_AUIToolbar::GetToolSize(
    wxDC& dc,
    wxWindow* WXUNUSED(wnd),
    const wxAuiToolBarItem& item)
{
...
void vxCstmArtPrvdr_AUIToolbar::DrawSeparator(
    wxDC& dc,
    wxWindow* WXUNUSED(wnd),
    const wxRect& _rect)
{
    ...
    dc.GradientFillLinear(rect, *wxLIGHT_GREY, *wxLIGHT_GREY, horizontal ? wxSOUTH : wxEAST);
}

void vxCstmArtPrvdr_AUIToolbar::DrawGripper(wxDC& dc,
                                 wxWindow* WXUNUSED(wnd),
                                 const wxRect& rect)
{
    int i = 0;
...
void vxCstmArtPrvdr_AUIToolbar::DrawOverflowButton(wxDC& dc,
                                        wxWindow* /*wnd*/,
                                        const wxRect& rect,
                                        int state)
{
...
int vxCstmArtPrvdr_AUIToolbar::GetElementSize(int element_id)
{
    switch (element_id)
    {
...
void vxCstmArtPrvdr_AUIToolbar::SetElementSize(int element_id, int size)
{
    switch (element_id)
    {
    case wxAUI_TBART_SEPARATOR_SIZE:
...
int vxCstmArtPrvdr_AUIToolbar::ShowDropDown(wxWindow* wnd,
